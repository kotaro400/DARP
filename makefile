a.out :	main.o InputData.o myfunction.o Location.o Request.o Route.o Cost.o RouteList.o Solution.o
	g++ main.o InputData.o myfunction.o Location.o Request.o Route.o Cost.o RouteList.o Solution.o -I/Library/gurobi900/mac64/include -L/Library/gurobi900/mac64/lib -lgurobi_c++ -lgurobi90
