...
a.out :	ex_main.o InputData.o myfunction.o Location.o Request.o Cost.o RouteList.o
	g++ ex_main.o InputData.o myfunction.o Location.o Request.o Cost.o RouteList.o -I/Library/gurobi900/mac64/include -L/Library/gurobi900/mac64/lib -lgurobi_c++ -lgurobi90
ex_main.o : ex_main.cpp InputData.hpp Location.hpp Cost.hpp myfunction.hpp RouteList.hpp
	g++ -c ex_main.cpp -o ex_main.o -I/Library/gurobi900/mac64/include -L/Library/gurobi900/mac64/lib -lgurobi_c++ -lgurobi90
