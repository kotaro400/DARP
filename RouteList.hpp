...
public:
    ...
    tuple<int, int> OuterRouteChange_random(int customerSize); // 他のルートに挿入 インデックスはランダム
    ...
    tuple<int, int> OuterRouteChange_worstNode(int customerSize,int WorstNode); //ペナルティの大きいノードを他のルートに挿入
};