...
本研究では、目的関数をルートの総距離と顧客の不満度合いの重み付き和として、その最小化を考えている。2つの係数$\alpha,\beta$の値を変化させた際の計算結果を表に示す。
...
\begin{landscape}
  ...
  r1b                  & \multicolumn{1}{c}{24}  & \multicolumn{1}{c}{3}   & 200.74                       & 0.00                      & 197.489                       & 0.00                        & 203.61                        & 0.00                       & 195.6                        & 0.0
                           \\
